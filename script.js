...
document.getElementById("generate-report").addEventListener("click", () => {
    ...
    const doc = new jsPDF();
    const headerColor = "#007a6c"; // Teal for headings
    const textFontSize = 12;
    const textColor = "#333"; // Black for user-provided inputs
    const margin = 10;
    let yOffset = margin;
    ...
    const addSectionTitle = (title) => {
        ...
        doc.setFontSize(14);
        doc.setTextColor(headerColor); // Set teal color for headings
    ...
    const addText = (text) => {
        ...
        doc.setTextColor(textColor); // Set black color for user inputs
    ...
    // Radar Chart Section
    addPage(); // Ensure chart is on its own page
